...
import enum
import typing
__all__: list[str] = ['ACC', 'ArmComponent', 'CANDevice', 'CANDeviceCollection', 'CANPacket', 'CANSocket', 'CANSocketException', 'COUNT', 'CTRL_MODE', 'CallbackMode', 'CanFdFrame', 'CanFrame', 'CanPacketDecoder', 'CanPacketEncoder', 'DEC', 'DM10010', 'DM10010L', 'DM3507', 'DM4310', 'DM4310_48V', 'DM4340', 'DM4340_48V', 'DM6006', 'DM8006', 'DM8009', 'DMDeviceCollection', 'DMG6220', 'DMH3510', 'DMH6215', 'Damp', 'Deta', 'ESC_ID', 'Flux', 'GREF', 'Gr', 'GripperComponent', 'IGNORE', 'IQ_c1', 'I_BW', 'Inertia', 'KI_APR', 'KI_ASR', 'KP_APR', 'KP_ASR', 'KT_Value', 'LS', 'LimitParam', 'MAX_SPD', 'MITParam', 'MST_ID', 'Motor', 'MotorDeviceCan', 'MotorStateResult', 'MotorType', 'MotorVariable', 'NPP', 'OC_Value', 'OT_Value', 'OV_Value', 'OpenArm', 'PARAM', 'PMAX', 'ParamResult', 'PosVelParam', 'Rs', 'SN', 'STATE', 'TIMEOUT', 'TMAX', 'UV_Value', 'VL_c1', 'VMAX', 'V_BW', 'can_br', 'dir', 'hw_ver', 'k1', 'k2', 'm_off', 'p_m', 'sub_ver', 'sw_ver', 'u_off', 'v_off', 'xout']
class ArmComponent(DMDeviceCollection):
    ...
    def __init__(self, can_socket: CANSocket) -> None:
        ...
    def init_motor_devices(self, motor_types: collections.abc.Sequence[MotorType], send_can_ids: collections.abc.Sequence[int], recv_can_ids: collections.abc.Sequence[int], use_fd: bool) -> None:
        ...
class CANDevice:
    @staticmethod
    def __new__(type, *args, **kwargs):
...
class GripperComponent(DMDeviceCollection):
    ...
    def __init__(self, can_socket: CANSocket) -> None:
        ...
    def close(self, kp: float = 50.0, kd: float = 1.0) -> None:
        ...
    def get_motor(self) -> Motor:
        ...
    def init_motor_device(self, motor_type: MotorType, send_can_id: int, recv_can_id: int, use_fd: bool) -> None:
        ...
    def open(self, kp: float = 50.0, kd: float = 1.0) -> None:
        ...
class LimitParam:
    pMax: float
    tMax: float
...
class OpenArm:
    ...
    def get_master_can_device_collection(self) -> CANDeviceCollection:
        ...
    def init_arm_motors(self, motor_types: collections.abc.Sequence[MotorType], send_can_ids: collections.abc.Sequence[int], recv_can_ids: collections.abc.Sequence[int]) -> None:
        ...
    def init_gripper_motor(self, motor_type: MotorType, send_can_id: int, recv_can_id: int) -> None:
        ...
    def query_param_all(self, rid: int) -> None:
        ...
